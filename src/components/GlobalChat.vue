...
C15.786,7.8,14.8,8.785,14.8,10s0.986,2.2,2.201,2.2S19.2,11.215,19.2,10S18.216,7.8,17.001,7.8z"/>
                            ...
                            <div class="flex items-center group">
                                <p class="px-6 py-3 rounded-r-3xl bg-gray-800 max-w-xs lg:max-w-md text-gray-200">
...
C15.786,7.8,14.8,8.785,14.8,10s0.986,2.2,2.201,2.2S19.2,11.215,19.2,10S18.216,7.8,17.001,7.8z"/>
                            ...
                            <div class="flex items-center group">
                                <p class="px-6 py-3 rounded-b-3xl rounded-r-3xl bg-gray-800 max-w-xs lg:max-w-md text-gray-200">Lorem ipsum
                                    dolor sit
